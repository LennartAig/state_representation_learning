...
class Policy(nn.Module):
    """
    """
    def __init__(self, encoder, **kwargs): #state_dim, action_dim, act_limit, param, use_cnn=False, img_channels= 3, envtype = "Box"):
        ...
        if kwargs['envtype'] == "Discrete": 
            ...
            self.dist = Gaussian(
                num_inputs=dist_in_dim, num_outputs=kwargs['action_dim'],
                fixed_std = True,log_std_min=-20,log_std_max=2
                )
...
class ValueFunction(nn.Module):
    ...
    def __init__(self, encoder=None, **kwargs):
        ...
        self.mlp, _ = make_mlp(input_dim=kwargs['input_dim_critic'],
