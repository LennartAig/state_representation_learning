...
from srl_framework.envs.wrappers import (
    FrameStack,
    NormalizeWrapper,
    ResizeWrapper,
    PyTorchObsWrapper,
...
def make_env(args, image_size):
    ...
    if (
        args.env_type == "ducky"
        or args.env_type == "procgen"
        or args.env_type == "maze"
        or args.env_type == "miniworld"
    ):
        env = ResizeWrapper(
            PyTorchObsWrapper(env), resize_w=image_size, resize_h=image_size
        )
